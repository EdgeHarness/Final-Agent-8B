...
TASK = "Read Dana's newest email and do what she asks: build the spreadsheet and the deck"
...
js("(()=>{const t=[...document.querySelectorAll('#tabs .tab')].find(b=>/xlsx/i.test(b.textContent));"
   "if(t)t.click();return 'sheet tab';})()")
